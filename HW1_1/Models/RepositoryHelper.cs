namespace HW1_1.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶資料關聯表Repository Get客戶資料關聯表Repository()
		{
			var repository = new 客戶資料關聯表Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶資料關聯表Repository Get客戶資料關聯表Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶資料關聯表Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
